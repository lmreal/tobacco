...
public class Employee implements Serializable {
    ...
    @Excel(name = "出生日期", width = 20, databaseFormat = "yyyyMMddHHmmss", format = "yyyy-MM-dd", isImportField = "true")
    ...
    @Excel(name = "参加工作时间", width = 20, databaseFormat = "yyyyMMddHHmmss", format = "yyyy-MM-dd", isImportField = "true")
    private Date entryDate;

    public Employee() {}

    public Employee(String name, String idNo, Integer age, Date birthday, String mobile, String degree, String department, String category, String position, Date entryDate) {
        this.name = name;
        this.idNo = idNo;
        this.age = age;
