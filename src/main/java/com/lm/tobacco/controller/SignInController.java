...
public class SignInController {
    ...
    public void toHtmlOf07Base(HttpServletResponse response) throws Exception {
        ExcelToHtmlParams params = new ExcelToHtmlParams(WorkbookFactory.create(POICacheManager.getFile("E://人员签到 - 副本.xlsx")));
    ...
    @Autowired
    private VocationRequestServiceImpl vocationRequestService;
