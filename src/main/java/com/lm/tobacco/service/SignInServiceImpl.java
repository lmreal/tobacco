...
public class SignInServiceImpl implements SignInService {
    ...
    private String saveImage(MultipartFile multipartFile, String fileName) throws IOException {
        ...
        String name = HashUtil.getSHA256Str(fileName) + "." +  fileName.substring(fileName.lastIndexOf(".") + 1);;
        BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(path + File.separator + name));
